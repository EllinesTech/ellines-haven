...
const INTEGRATIONS = [
  ...
  { id:'paystack',    icon:'🟢', name:'Paystack',            cat:'Payments',   status:'active', desc:'M-Pesa, Visa, Mastercard, and bank — instant unlock.',     fields:[{k:'pubKey',l:'Public Key',ph:'pk_live_…'}] },
  ...
  { id:'paypal',      icon:'🅿', name:'PayPal',              cat:'Payments',   status:'config', desc:'Accept PayPal, credit & debit cards worldwide.',           fields:[{k:'clientId',l:'Client ID',ph:'AXxxx…'},{k:'mode',l:'Mode',ph:'live'}] },
  { id:'flutterwave', icon:'🦋', name:'Flutterwave',         cat:'Payments',   status:'idle',   desc:'Pan-African payments: mobile money, cards, bank transfers.',fields:[{k:'pubKey',l:'Public Key',ph:'FLWPUBK_TEST-…'}] },
  { id:'stripe',      icon:'💳', name:'Stripe',              cat:'Payments',   status:'config', desc:'International card payments — Visa, Mastercard, Amex.',   fields:[{k:'pubKey',l:'Publishable Key',ph:'pk_live_…'}] },
