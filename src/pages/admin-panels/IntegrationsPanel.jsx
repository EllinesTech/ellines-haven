...
const INTEGRATIONS = [
  ...
  { id:'mpesa',      icon:'📱', name:'M-Pesa Daraja',       cat:'Payments',     status:'active',  desc:'STK push, C2B, and B2C mobile payments.',                 fields:[{k:'shortcode',l:'Shortcode',ph:'174379'},{k:'passkey',l:'Passkey',ph:'••••••••'}] },
  ...
  { id:'stripe',     icon:'💳', name:'Stripe',              cat:'Payments',     status:'config',  desc:'International card payments via Stripe.',                 fields:[{k:'pubKey',l:'Publishable Key',ph:'pk_live_…'},{k:'secKey',l:'Secret Key',ph:'sk_live_…'}] },
