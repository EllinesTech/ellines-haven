...
function AudioPlayer({ chapters, currentChapter, onChapterChange }) {
  ...
  function isNeuralVoice(v) {
    ...
    // 🔵 Neural (Android Chrome / Chrome OS)
    if (/^google /i.test(v.name)) return true; // Google voices are all neural-quality
  ...
  useEffect(() => {
    const load = () => {
      ...
      // Priority order: Microsoft Neural > 🔵 Neural > iOS enhanced >
