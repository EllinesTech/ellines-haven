...
const PageEditorPanel   = lazy(lazyRetry(() => import('./admin-panels/PageEditorPanel')));
const DesignStudioPanel = lazy(lazyRetry(() => import('./admin-panels/DesignStudioPanel')));
const SecurityPanel     = lazy(lazyRetry(() => import('./admin-panels/SecurityPanel')));
const PluginsPanel      = lazy(lazyRetry(() => import('./admin-panels/PluginsPanel')));
const GodModePanel      = lazy(lazyRetry(() => import('./admin-panels/GodModePanel')));
const IntegrationsPanel = lazy(lazyRetry(() => import('./admin-panels/IntegrationsPanel')));
const MessagesPanel     = lazy(lazyRetry(() => import('./admin-panels/MessagesPanel')));
const LiveChatPanel     = lazy(lazyRetry(() => import('./admin-panels/LiveChatPanel')));
const ReportsPanel      = lazy(lazyRetry(() => import('./admin-panels/ReportsPanel')));
const AnalyticsPanel    = lazy(lazyRetry(() => import('./admin-panels/AnalyticsPanel')));
const ReviewsPanel      = lazy(lazyRetry(() => import('./admin-panels/ReviewsPanel')));
const EmailPanel        = lazy(lazyRetry(() => import('./admin-panels/EmailPanel')));
const NewsletterPanel   = lazy(lazyRetry(() => import('./admin-panels/NewsletterPanel')));
const VisitorsPanel     = lazy(lazyRetry(() => import('./admin-panels/VisitorsPanel')));
const ActivityPanel     = lazy(lazyRetry(() => import('./admin-panels/ActivityPanel')));
const SMSPanel          = lazy(lazyRetry(() => import('./admin-panels/SMSPanel')));
const ChatSettingsPanel = lazy(lazyRetry(() => import('./admin-panels/ChatSettingsPanel')));
const SocialHandlesPanel = lazy(lazyRetry(() => import('./admin-panels/SocialHandlesPanel')));
const PaymentFeesPanel  = lazy(lazyRetry(() => import('./admin-panels/PaymentFeesPanel')));
const ContentProtectionPanel = lazy(lazyRetry(() => import('./admin-panels/ContentProtectionPanel')));
const DeviceSettingsPanel    = lazy(lazyRetry(() => import('./admin-panels/DeviceSettingsPanel')));
const OnlineUsersPanel       = lazy(lazyRetry(() => import('./admin-panels/OnlineUsersPanel')));
const AdminOrdersPanel       = lazy(lazyRetry(() => import('./admin-panels/AdminOrdersPanel')));
const SeriesPanel            = lazy(lazyRetry(() => import('./admin-panels/SeriesPanel')));
const ChapterGrantsPanel     = lazy(lazyRetry(() => import('./admin-panels/ChapterGrantsPanel')));
const ChapterAnalyticsPanel  = lazy(lazyRetry(() => import('./admin-panels/ChapterAnalyticsPanel')));
const FreeBookPanel          = lazy(lazyRetry(() => import('./admin-panels/FreeBookPanel')));
const ResponsiveLayoutEditor = lazy(lazyRetry(() => import('./admin-panels/ResponsiveLayoutEditor')));
const AuthorBlogPanel        = lazy(lazyRetry(() => import('./admin-panels/AuthorBlogPanel')));
const BookSeriesPanel        = lazy(lazyRetry(() => import('./admin-panels/BookSeriesPanel')));
const AdvancedSearchPanel    = lazy(lazyRetry(() => import('./admin-panels/AdvancedSearchPanel')));
const PreOrderPanel          = lazy(lazyRetry(() => import('./admin-panels/PreOrderPanel')));
const EmailNotificationPanel = lazy(lazyRetry(() => import('./admin-panels/EmailNotificationPanel')));
const CommentThreadsPanel    = lazy(lazyRetry(() => import('./admin-panels/CommentThreadsPanel')));
const ChallengesPanel        = lazy(lazyRetry(() => import('./admin-panels/ChallengesPanel')));
